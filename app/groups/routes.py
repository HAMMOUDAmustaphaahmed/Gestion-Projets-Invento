...
def view(group_id):
    ...
    # Tâches assignées au groupe - utiliser une requête au lieu de la relation
...
def delete(group_id):
    ...
    # Vérifier si le groupe est assigné à des tâches
...
def manage_members(group_id):
    ...
    # Pré-remplir les membres actuels
...
def groups_stats():
    ...
    # Groupe avec le plus de membres
